...
path_bidsdata = os.path.join(os.sep, 'home', 'cmccann2', 'bids_tutorial' 'bids_data')  # Where your subjects' nifti directories are
...
timepoint2 = TimePoint('ses-wave2', [sequence1, sequence2, sequence5])  # Add as many timepoints as needed and fill it with the correct sequences
